...
<head>
  ...
  <link rel="stylesheet" href="/resources/css/guide/useInfo.css" />
...
<body>
  ...
  <main class="container">
    ...
    <section>
      ...
      <ul><li>02742 서울특별시 종로구 청계천로 212</li></ul>
    </section>
    ...
    <section>
      ...
      <div class="book-loan-guide">
        <div class="book-loan-guide-map">도서관 홈페이지 접속,<br />로그인 후</div>
        <div class="arrow">→</div>
        <div class="book-loan-guide-map">도서 조회 및<br />[신청하기] 버튼 클릭</div>
        <div class="arrow">→</div>
    ...
    <section>
      ...
      <ul>
        ...
        <li>도서관 정책상 선정 기준에 맞지 않거나, 일부 내용이 부적절한 도서는 신청이 제한될 수 있습니다.</li>
      </ul>
    </section>
